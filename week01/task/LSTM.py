...
# class_indexs编码字段序列号，或者序列号list，列表从0开始
...
if __name__ == '__main__':
    ...
    # 生成数据集，使用前5次的数据来预测新数据
    dataset = convert_dataset(data, n_input=n_input)
    values = dataset.values  # .astpye('float32')
    ...
    x_validation = scalar.fit_transform(x_validation)
